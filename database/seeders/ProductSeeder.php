...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Variant Manis
        Product::create(['variant_id' => 1, 'name' => 'Almond Coklat', 'net_weight' => 355, 'price_regular' => 115000, 'price_jar' => 70000]);
        ...
        Product::create(['variant_id' => 1, 'name' => 'Nastar Klasik', 'net_weight' => 420, 'price_regular' => 115000, 'price_jar' => 70000]);
        ...
        Product::create(['variant_id' => 1, 'name' => 'Red Velvet', 'net_weight' => 320, 'price_regular' => 115000, 'price_jar' => 70000]);
        Product::create(['variant_id' => 1, 'name' => 'Sagu Keju', 'net_weight' => 285, 'price_regular' => 115000, 'price_jar' => 70000]);

        // Variant Asin
        Product::create(['variant_id' => 2, 'name' => 'Cheeskrez', 'net_weight' => 355, 'price_regular' => 115000, 'price_jar' => 70000]);
        Product::create(['variant_id' => 2, 'name' => 'Ebi Bawang', 'net_weight' => 365, 'price_regular' => 115000, 'price_jar' => 0]);
        Product::create(['variant_id' => 2, 'name' => 'Kastengel', 'net_weight' => 355, 'price_regular' => 115000, 'price_jar' => 70000]);
        ...
        Product::create(['variant_id' => 3, 'name' => 'Chocochips', 'net_weight' => 335, 'price_regular' => 115000, 'price_jar' => 70000]);
        ...
        Product::create(['variant_id' => 3, 'name' => 'Medeci', 'net_weight' => 365, 'price_regular' => 115000, 'price_jar' => 70000]);

        // Hampers Idul Fitri
        Hamper::create(['name' => 'Hamper Regular Isi 2', 'description' => '2 toples reguler, Hardbox Premium, Free Greeting Card', 'category' => 'eid', 'price' => 275000]);
        Hamper::create(['name' => 'Hamper Regular Isi 3', 'description' => '3 toples reguler, Hardbox Premium, Free Greeting Card', 'category' => 'eid', 'price' => 390000]);
        Hamper::create(['name' => 'Hamper Regular Isi 4', 'description' => '4 toples reguler, Hardbox Premium, Free Greeting Card', 'category' => 'eid', 'price' => 500000]);
        Hamper::create(['name' => 'Hamper Regular Isi 6', 'description' => '6 toples reguler, Hardbox Premium, Free Greeting Card', 'category' => 'eid', 'price' => 730000]);

        Hamper::create(['name' => 'Hamper Jar Isi 2', 'description' => '2 jar reguler, Hardbox Premium, Free Greeting Card', 'category' => 'eid', 'price' => 275000]);
        Hamper::create(['name' => 'Hamper Jar Isi 3', 'description' => '3 jar reguler, Hardbox Premium, Free Greeting Card', 'category' => 'eid', 'price' => 390000]);
        ...
        // Hamper Tahun Baru
        Hamper::create(['name' => 'Hamper Regular Isi 2', 'description' => '2 toples reguler, Hardbox Premium, Free Greeting Card', 'category' => 'new_year', 'price' => 275000]);
        Hamper::create(['name' => 'Hamper Regular Isi 3', 'description' => '3 toples reguler, Hardbox Premium, Free Greeting Card', 'category' => 'new_year', 'price' => 390000]);
        Hamper::create(['name' => 'Hamper Regular Isi 4', 'description' => '4 toples reguler, Hardbox Premium, Free Greeting Card', 'category' => 'new_year', 'price' => 500000]);
    }
}
