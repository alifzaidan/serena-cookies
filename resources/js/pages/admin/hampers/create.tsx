...
export default function CreateHamper() {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('hampers.store'));
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Hampers" />
            <div className="px-4 py-4 md:px-6">
                <div className="mb-6">
                    <h1 className="text-2xl font-semibold">Tambah Hampers Baru</h1>
                    <p className="text-sm text-muted-foreground">Silakan isi form untuk menambah hampers baru.</p>
                </div>
